...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.xperience.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.xpe.device";
    ...
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "xperience.updater.allow_major_update";
